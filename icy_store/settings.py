"""
Django settings for icy_store project.
...
SECRET_KEY = 'django-insecure-%&@5%51xrszu16gq=uulx&q*r@9(r!)^9*0x@5y-893g$82la)'
...
WSGI_APPLICATION = 'icy_store.wsgi.application'
